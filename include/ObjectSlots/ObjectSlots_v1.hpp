#ifndef _OBJECTSLOTS_V1_HPP_
#define _OBJECTSLOTS_V1_HPP_

#include <ObjectSlots/objectslots_config.hpp>
#ifdef ENABLE_OBJECTSLOTS_V1
#include <functional>
#include <atomic>
#include <vector>
#include <memory>
...
namespace v1 {
    ...
    // Forward declaration of Slot matching the variadic signature
